...
<main className="overflow-hidden">
        ...
        <section className="relative bg-white" aria-labelledby="contact-heading">
          ...
          <StaticImage
              src="../images/countertop-install.jpg"
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="relative bg-white shadow-xl">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3">
                {/* Contact information */}
                <div className="relative overflow-hidden bg-gradient-to-b from-primary-500 to-primary-600 py-10 px-6 sm:px-10 xl:p-12">
                  ...
                  <h3 className="text-lg font-medium text-teal-200">Contact information</h3>
                  <p className="mt-6 max-w-3xl text-base text-white">
                    Let us know how we can turn your dream project into reality
                  </p>
                  <dl className="mt-8 space-y-6">
                    ...
                    <dd className="flex text-base text-teal-50">
                      <GoMail className="h-6 w-6 flex-shrink-0 text-white" aria-hidden="true" />
                      <span className="ml-3">info@ecgranite.com</span>
                    </dd>
                  </dl>
                ...
                <div className="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
                  <h3 className="text-lg font-medium text-warm-gray-900">Tell Us About Your Project</h3>
                  <form action="#" method="POST" className="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                    ...
                    <div className="sm:col-span-2 sm:flex sm:justify-end">
                      <button
                        type="submit"
                        className="mt-2 inline-flex w-full items-center justify-center rounded-md border border-transparent bg-primary-500 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-teal-600 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 sm:w-auto"
                      >
                        Submit
                      </button>
                    </div>
